...
namespace PSSC_S3
{
    public class Program
    {
        ...
        {
            Produs produs1 = new Produs(new Cantitate.CantitateKg(2), "cod1", "paine", 5);
            Produs produs2 = new Produs(new Cantitate.CantitateUnitati(4), "cod2", "lapte", 8);
            Produs produs3 = new Produs(new Cantitate.CantitateKg(8), "cod3", "oua", 10);
            ...
            foreach (var produs in Produse)
            {
                ...
                Console.WriteLine($"Pretul produsului: {produs.Pret}");

                totalComanda += cantitateIntrodusa * produs.Pret;
            }
            Console.WriteLine($"Pretul intreg al comenzii: {totalComanda}");
